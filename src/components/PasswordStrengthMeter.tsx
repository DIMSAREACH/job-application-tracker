...
import { Check, X, Wand2, ShieldCheck } from "lucide-react";
...
export function PasswordStrengthMeter({
  ...
  if (!password && !onGeneratePassword) return null;
      ...
      {onGeneratePassword && (
        <div className="pt-1">
          <Button
            ...
            className="w-full gap-1.5 rounded-xl border-indigo-200 bg-white text-indigo-700 hover:bg-indigo-50 dark:border-indigo-500/30 dark:bg-slate-950 dark:text-indigo-300 dark:hover:bg-indigo-950/40 text-xs font-semibold shadow-xs"
          >
